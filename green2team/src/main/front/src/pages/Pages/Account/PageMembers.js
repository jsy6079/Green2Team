...
class PageMembers extends Component {
  ...
  render() {
    const { showDashboardSubMenu, showContentManagementSubMenu,showInformationManagementSubMenu,showAccountManagementSubMenu } = this.state;
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header border-bottom p-3">
                        <h5 className="modal-title" id="exampleModalLabel">VR 콘텐츠 등록</h5>
