...
import b02 from "../../../assets/images/blog/02.jpg";
import b03 from "../../../assets/images/blog/03.jpg";
import b04 from "../../../assets/images/blog/04.jpg";
import b05 from "../../../assets/images/blog/05.jpg";
import b06 from "../../../assets/images/blog/06.jpg";
import b07 from "../../../assets/images/blog/07.jpg";
import b08 from "../../../assets/images/blog/08.jpg";
                        ...
                        <div className="sidebar-content" data-simplebar style={{ height: 'calc(100% - 60px)' }}>
                            ...
                            <ul className="sidebar-menu">
                                <li className="sidebar-dropdown">
                                    <a href="javascript:void(0)" ><i className="ti ti-home me-2"></i>대시보드</a>
                                    {/* <div className="sidebar-submenu"> */}
                                    <div>
                                        <ul>
                                            <li><a href="/page-chat">통계데이터</a></li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li className="sidebar-dropdown">
                                    <a href="javascript:void(0)"><i className="ti ti-brand-youtube me-2"></i>콘텐츠 관리</a>
                                    {/* <div className="sidebar-submenu"> */}
                                    <div>
                                        <ul>
                                        <li><a href="/page-invoice">아카이브 콘텐츠</a></li>
                                        <li><a href="javascript:void(0)">VR 콘텐츠</a></li>
                                        <li><a href="javascript:void(0)">AR 콘텐츠</a></li>
                                        <li><a href="/page-payments">동영상 콘텐츠</a></li>
                                ...
                                <li className="sidebar-dropdown">
                                    <a href="javascript:void(0)"><i className="ti ti-address-book me-2"></i>기준정보 관리</a>
                                    {/* <div className="sidebar-submenu"> */}
                                    <div>
                                        <ul>
                                ...
                                <li className="sidebar-dropdown">
                                    <a href="javascript:void(0)"><i className="ti ti-users me-2"></i>계정 관리</a>
                                    {/* <div className="sidebar-submenu"> */}
                                    <div>
                                        <ul>
                                            <li><a href="/page-profile">계정 권한 관리</a></li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
              ...
              <div className="top-header">
                <div className="header-bar d-flex justify-content-between">
                    <div className="d-flex align-items-center">
                        ...
                        <a id="close-sidebar" className="btn btn-icon btn-soft-light" href="javascript:void(0)">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb" className="d-inline-block mt-1">
                            <ul className="breadcrumb breadcrumb-muted bg-transparent rounded mb-0 p-0">
                                ...
                                <li className="breadcrumb-item text-capitalize active" aria-current="page">AR 콘텐츠</li>
                            </ul>
                        </nav>
                    </div>
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header border-bottom p-3">
                        <h5 className="modal-title" id="exampleModalLabel">AR 콘텐츠 등록</h5>
                        ...
                        <div className="row">
                            ...
                            <div className="col-12">
                                ...
                                <div className="d-grid">
                                    ...
                                    <input type="file" id="input-file" name="input-file" accept="image/*"  onChange={this.handleNameChange} />
                                    
                                        {/* <input type="file" id="input-file" name="input-file" accept="image/*" onChange={this.handleFileChange} hidden /> */}
                                        <div id="editor"></div>
                                </div>
                            </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="mb-3">
                                                    ...
                                                    <input name="date" type="text" className="form-control" id="date" value="09 January 2021"/>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-md-6">
                                                <div className="mb-3">
                                                    ...
                                                    <input name="time" type="text" className="form-control" id="time" value="5 min read"/>
                                                </div>
                                            </div>
                  ...
                  <div className="row">
                    <div className="col-xl-3 col-lg-4 col-md-6 mt-4">
                        <div className="card blog blog-primary rounded border-0 shadow overflow-hidden">
                            <div className="position-relative">
                                <img src={b02} className="card-img-top" alt="..."/>
                            ...
                            <div className="card-body content">
                                ...
                                <div className="post-meta d-flex justify-content-between mt-3">
                                    <a href="javascript:void(0)" className="btn btn-primary " style={{ width: '90px', height: '40px', fontSize: '12px' }}> 수정</a>
                                        <a href="javascript:void(0)" className="btn btn-primary" style={{ width: '90px', height: '40px', fontSize: '12px' }}>삭제</a>

                                </div>
                            </div>
                            <div className="author">
                                <small className="text-white user d-block"><i className="uil uil-user"></i> Calvin Carlo</small>
                                <small className="text-white date"><i className="uil uil-calendar-alt"></i> 25th June 2021</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 mt-4">
                        <div className="card blog blog-primary rounded border-0 shadow overflow-hidden">
                            <div className="position-relative">
                                <img src={b03} className="card-img-top" alt="..."/>
                                <div className="overlay rounded-top"></div>
                            </div>
                            <div className="card-body content">
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 mt-4">
                        <div className="card blog blog-primary rounded border-0 shadow overflow-hidden">
                            <div className="position-relative">
                                <img src={b04} className="card-img-top" alt="..."/>
                                <div className="overlay rounded-top"></div>
                            </div>
                            <div className="card-body content">
                                <h5><a href="javascript:void(0)" className="card-title title text-dark">How apps is changing the IT world</a></h5>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 mt-4">
                        <div className="card blog blog-primary rounded border-0 shadow overflow-hidden">
                            <div className="position-relative">
                                <img src={b05} className="card-img-top" alt="..."/>
                                <div className="overlay rounded-top"></div>
                            </div>
                            <div className="card-body content">
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 mt-4">
                        <div className="card blog blog-primary rounded border-0 shadow overflow-hidden">
                            <div className="position-relative">
                                <img src={b06} className="card-img-top" alt="..."/>
                                <div className="overlay rounded-top"></div>
                            </div>
                            <div className="card-body content">
                                <h5><a href="javascript:void(0)" className="card-title title text-dark">Smartest Applications for Business</a></h5>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 mt-4">
                        <div className="card blog blog-primary rounded border-0 shadow overflow-hidden">
                            <div className="position-relative">
                                <img src={b07} className="card-img-top" alt="..."/>
                                <div className="overlay rounded-top"></div>
                            </div>
                            <div className="card-body content">
                                <h5><a href="javascript:void(0)" className="card-title title text-dark">Design your apps in your own way</a></h5>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 mt-4">
                        <div className="card blog blog-primary rounded border-0 shadow overflow-hidden">
                            <div className="position-relative">
                                <img src={b08} className="card-img-top" alt="..."/>
                                <div className="overlay rounded-top"></div>
                            </div>
                            <div className="card-body content">
                                <h5><a href="javascript:void(0)" className="card-title title text-dark">Smartest Applications for Business</a></h5>
