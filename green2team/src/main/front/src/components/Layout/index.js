...
class Layout extends Component { 
  render() {
    const tagLineContent = this.props.router.location.pathname === "/index-crypto-two" ? <Tagline><CryptoTagline /></Tagline> : null;
    return (
      <React.Fragment>
        <Suspense fallback={Loader()}>
          ...
          {(() => {
            if (
              ...
              this.props.router.location.pathname === "/index-modern-business" ||
              ...
              this.props.router.location.pathname === '/helpcenter-support-request' ||
