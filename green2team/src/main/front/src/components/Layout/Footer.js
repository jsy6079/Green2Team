...
const FooterWithConditionalRendering = () => {
  ...
  // 현재 경로가 "/page-chat"이면 Footer를 렌더링하지 않음
  if (location.pathname === "/page-chat") {
    return null;
  }else if(location.pathname === "/page-profile"){
    return null;
  }else if(location.pathname.startsWith ("/page-profile-edit/")){
    return null;
  }else if(location.pathname === "/page-invoice"){
    return null;
  }else if(location.pathname === "/page-members"){
    return null;
  }else if(location.pathname === "/page-messages"){
    return null;
  }else if(location.pathname === "/page-payments"){
    return null;
  }else if(location.pathname.startsWith ("/page-works1/")){
    return null;
  }else if(location.pathname.startsWith ("/page-works2/")){
    return null;
  }else if(location.pathname === "/page-works2"){
    return null;
  }
  


  // 다른 경우에는 기존 Footer를 렌더링함
  return <Footer />;
};

export default FooterWithConditionalRendering;
