...
class BlogBox extends Component {
  ...
  render() {
    ...
    const originalDate = new Date(blog.vrRegdate); // blog.vrRegdate를 Date 객체로 변환
    ...
    return {
      ...blog,
      vrRegdate: formattedDate, // 변경된 날짜로 업데이트된 블로그 객체 반환
      vrBoardContent: truncatedContent // 변경된 글자수를 블로그 객체 반환
      };
    });
          ...
          <Col lg="4" md="6" className="mt-4 pt-2" key={key} name="blog" style={{ display: 'flex' }}>
            <Card className="blog rounded border-0 shadow">
              <div className="position-relative">
                <CardImg top src={blog.vrThumbnailImgUrl} className="rounded-top" alt="" style={{ width: '350px', height: '235px' }}/>
              ...
              <CardBody className="content m-0" >
                ...
                <div className="post-meta d-flex justify-content-between mt-3">
                  ...
                  <Link to={`/page-case-detail/${blog.vrBoardNo}`} className="text-muted readmore" onClick={this.handleClick}>
              ...
              <div className="author">
                ...
                <small className="text-light date">
                  <i className="mdi mdi-calendar-check"></i> {blog.vrRegdate}
                </small>
              </div>
            </Card>
          </Col>
